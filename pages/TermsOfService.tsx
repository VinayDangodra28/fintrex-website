...
import { TERMS_OF_SERVICE, LegalDocument } from '../content/legal';

const TermsOfService: React.FC = () => {
  const doc: LegalDocument = TERMS_OF_SERVICE;
  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href="https://fintrex.ai/terms" />
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          >
            ...
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-brand/10 mb-6">
              <Scale className="text-brand" size={32} />
            </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm mb-4">
                      ...
                      <a href="mailto:legal@fintrex.ai" className="text-brand hover:underline">
                        legal@fintrex.ai
                      </a>
                    </p>
                    <Link
